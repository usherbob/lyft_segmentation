...
class DepthCompletionNet(nn.Module):
    def __init__(self, in_channels, num_out_channels, res_layers=34, pretrained=False):
        ...
        channels = 64
        self.conv1_img = conv_bn_relu(in_channels, channels, kernel_size=3, stride=1, padding=1)
